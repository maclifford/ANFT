...
$evCSS = @'
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  body{background:var(--paper);color:var(--ink);font-family:"Libre Franklin",system-ui,sans-serif;font-size:16px;line-height:1.65;-webkit-font-smoothing:antialiased}
  ...
  h1{font-family:"Libre Franklin",system-ui,sans-serif;font-weight:500;color:var(--navy);font-size:clamp(28px,4vw,40px);line-height:1.15}
  ...
  .foot-brand{font-family:"Libre Franklin",system-ui,sans-serif;font-size:21px;line-height:1.3;color:#fff}
  .foot-tagline{font-family:"Libre Franklin",system-ui,sans-serif;font-size:14.5px;color:#E7D9A8;letter-spacing:.06em;margin-top:8px}
...
function EvPage($rec){
  ...
  $p += '<link href="https://fonts.googleapis.com/css2?family=EB+Garamond:wght@400;500;600;700&family=Libre+Franklin:wght@400;500;600;700&display=swap" rel="stylesheet">'
  $p += '<style>'
  $p += $evCSS
